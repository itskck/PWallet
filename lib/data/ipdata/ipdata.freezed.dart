...
/// @nodoc
@JsonSerializable()
class _$_IpData with DiagnosticableTreeMixin implements _IpData {
  const _$_IpData(
      {this.country, this.regionName, @JsonKey(name: 'query') this.ip});
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'IpData(country: $country, regionName: $regionName, ip: $ip)';
  }
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'IpData'))
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, country, regionName, ip);
...
abstract class _IpData implements IpData {
  const factory _IpData(
      {final String? country,
      final String? regionName,
      @JsonKey(name: 'query') final String? ip}) = _$_IpData;
